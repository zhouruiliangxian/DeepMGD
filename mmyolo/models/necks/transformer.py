...
from mmyolo.models.necks.layers import Conv2d_BN, DropPath, h_sigmoid
...
class InjectionMultiSum_Auto_pool(nn.Module):
    def __init__(
        ...
        if not in5:
            ...
            self.local_embedding = ConvModule(128, oup, kernel_size=1, norm_cfg=self.norm_cfg, act_cfg=None)
