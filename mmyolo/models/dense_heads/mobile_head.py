...
class MobileHeadModule(BaseModule):
    ...
    def __init__(self,
        ...
        for channel in self.in_channels:
            channel = make_divisible(channel, 1)
    ...
    def _init_layers(self):
        ...
        for i in range(self.num_levels):
            ...
            self.cls_preds.append(
                ...
                #         kernel_size=1)))
                nn.Sequential(
                    nn.Sequential(Conv(self.in_channels[i], self.in_channels[i], 3, g=self.in_channels[i]), Conv(self.in_channels[i], cls_out_channels, 1)),
                    nn.Sequential(Conv(cls_out_channels, cls_out_channels, 3, g=cls_out_channels), Conv(cls_out_channels, cls_out_channels, 1)),
                    nn.Conv2d(cls_out_channels, self.num_classes, 1),
                )
